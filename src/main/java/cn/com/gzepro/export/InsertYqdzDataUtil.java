 ...
 * 增量插入用气地址
 */
public class InsertYqdzDataUtil {
    /**
     * 获取的字段
     */
    ...
    static void insert() {
        ...
        try {
            ...
            String sql2 = "select " + FIELDS + " from yongqidizhi where yqdz_id = ? and rownum=1";
            stEpro1 = connEpro.prepareStatement(sql2);

            // 遍历
            int i = 0;
            while(rsGr.next()) {
                String yqdzId = rsGr.getString(1);
                stEpro1.setString(1, yqdzId);
